...
TEST(Test05VerifyAll, verifyAllWithHeaderAndVector)
{
    std::vector<int> numbers{ 0, 1, 2, 3};
    Approvals::verifyAll(
...
TEST(Test05VerifyAll, verifyAllWithHeaderContainerAndLambda)
{
...
TEST(Test05VerifyAll, verifyAllWithHeaderBeginEndAndLambda)
{
